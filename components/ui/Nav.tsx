  ...
  return (
    ...
    >
      ...
      <div
        id="mobile-menu"
        className={cn(
          "fixed inset-0 top-0 z-40 flex flex-col bg-sand px-[var(--side-padding)] pb-10 pt-28 transition-[opacity,visibility] duration-400 lg:hidden",
      ...
      >
        ...
        <div className="mt-auto">
          <MagneticButton href="#kontakt" variant="primary" className="w-full">
            Anfrage senden
          </MagneticButton>
        </div>
      </div>
